...
const roleResources: Record<string, Record<ResourceProvider, RoadmapResource[]>> = {
  "ai-engineer": {
    Udemy: [
      { title: "Full Stack Generative and Agentic AI with Python", provider: "Udemy", level: "Beginner", url: "https://www.udemy.com/course/full-stack-ai-with-python/" },
      { title: "AI Engineer Course", provider: "Udemy", level: "Beginner", url: "https://www.udemy.com/course/ai-engineer-course/" },
      { title: "Gen AI RAG Application Development", provider: "Udemy", level: "Intermediate", url: "https://www.udemy.com/course/gen-ai-rag-application-development/" },
      { title: "Full Stack AI Mastery: Python, React, FastAPI & LangChain", provider: "Udemy", level: "Intermediate", url: "https://www.udemy.com/course/full-stack-ai-mastery/" },
      { title: "LangChain - Develop LLM powered applications with LangChain", provider: "Udemy", level: "Intermediate", url: "https://www.udemy.com/course/langchain/" },
      { title: "Agentic AI Engineering with LangChain & LangGraph", provider: "Udemy", level: "Advanced", url: "https://www.udemy.com/course/complete-agentic-ai-bootcamp-with-langgraph-and-langchain/" },
      { title: "Master LLM Engineering", provider: "Udemy", level: "Advanced", url: "https://www.udemy.com/course/master-llm-engineering/" },
      { title: "Complete Agentic AI Bootcamp with LangGraph and LangChain", provider: "Udemy", level: "Advanced", url: "https://www.udemy.com/course/complete-agentic-ai-bootcamp-with-langgraph-and-langchain/" },
    ],
    "LinkedIn Learning": [
  ...
  "ai-devops": {
    Udemy: [
      ...
      { title: "AI Engineer Course", provider: "Udemy", level: "Beginner", url: "https://www.udemy.com/course/ai-engineer-course/" },
      { title: "Gen AI RAG Application Development", provider: "Udemy", level: "Intermediate", url: "https://www.udemy.com/course/gen-ai-rag-application-development/" },
      { title: "LangChain", provider: "Udemy", level: "Intermediate", url: "https://www.udemy.com/course/langchain/" },
      { title: "Complete Agentic AI Bootcamp with LangGraph and LangChain", provider: "Udemy", level: "Advanced", url: "https://www.udemy.com/course/complete-agentic-ai-bootcamp-with-langgraph-and-langchain/" },
      { title: "Full Stack AI Mastery", provider: "Udemy", level: "Advanced", url: "https://www.udemy.com/course/full-stack-ai-mastery/" },
    ],
    "LinkedIn Learning": [
  ...
  "ai-architect": {
    Udemy: [
      { title: "Software Architecture & Design of Modern Large Scale Systems", provider: "Udemy", level: "Beginner", url: "https://www.udemy.com/course/software-architecture-design-of-modern-large-scale-systems/" },
      { title: "Microservices Architecture - The Complete Guide", provider: "Udemy", level: "Intermediate", url: "https://www.udemy.com/course/microservices-architecture-the-complete-guide/" },
      { title: "AI for Presales and Solutions Architects", provider: "Udemy", level: "Intermediate", url: "https://www.udemy.com/course/ai-for-presales-and-solutions-architects/" },
      { title: "AI Engineer Course", provider: "Udemy", level: "Intermediate", url: "https://www.udemy.com/course/ai-engineer-course/" },
      { title: "Gen AI RAG Application Development", provider: "Udemy", level: "Advanced", url: "https://www.udemy.com/course/gen-ai-rag-application-development/" },
      { title: "Complete Agentic AI Bootcamp with LangGraph and LangChain", provider: "Udemy", level: "Advanced", url: "https://www.udemy.com/course/complete-agentic-ai-bootcamp-with-langgraph-and-langchain/" },
    ],
    "LinkedIn Learning": [
      { title: "Software Architecture Foundations", provider: "LinkedIn Learning", level: "Beginner", url: "https://www.linkedin.com/learning/software-architecture-foundations" },
      { title: "Microservices Foundations", provider: "LinkedIn Learning", level: "Intermediate", url: "https://www.linkedin.com/learning/microservices-foundations" },
  ...
  "ai-pm": {
    Udemy: [
      { title: "Artificial Intelligence for Project Managers", provider: "Udemy", level: "Beginner", url: "https://www.udemy.com/courses/search/?q=artificial+intelligence+for+project+managers" },
      { title: "Project Management with Generative AI", provider: "Udemy", level: "Intermediate", url: "https://www.udemy.com/courses/search/?q=project+management+generative+ai" },
      { title: "Prompt Engineering Masterclass", provider: "Udemy", level: "Intermediate", url: "https://www.udemy.com/courses/search/?q=prompt+engineering+masterclass" },
      { title: "Project Management with ChatGPT", provider: "Udemy", level: "Advanced", url: "https://www.udemy.com/courses/search/?q=project+management+chatgpt" },
    ],
    "LinkedIn Learning": [
  ...
  "ai-ba": {
    Udemy: [
      { title: "AI Engineer Course", provider: "Udemy", level: "Beginner", url: "https://www.udemy.com/course/ai-engineer-course/" },
      { title: "AI ChatGPT for QA Engineers", provider: "Udemy", level: "Beginner", url: "https://www.udemy.com/course/ai-chatgpt-for-qa-engineers/" },
      { title: "Next Gen QA Integrating Generative AI", provider: "Udemy", level: "Intermediate", url: "https://www.udemy.com/course/next-gen-qa-integrating-generative-ai-in-software-testing/" },
      { title: "Gen AI RAG Application Development", provider: "Udemy", level: "Intermediate", url: "https://www.udemy.com/course/gen-ai-rag-application-development/" },
      { title: "LangChain", provider: "Udemy", level: "Advanced", url: "https://www.udemy.com/course/langchain/" },
      { title: "Full Stack AI Mastery", provider: "Udemy", level: "Advanced", url: "https://www.udemy.com/course/full-stack-ai-mastery/" },
    ],
    "LinkedIn Learning": [
  ...
  "ai-tpm": {
    Udemy: [
      ...
      { title: "Project Management with Generative AI", provider: "Udemy", level: "Intermediate", url: "https://www.udemy.com/courses/search/?q=project+management+generative+ai" },
      { title: "Prompt Engineering Masterclass", provider: "Udemy", level: "Intermediate", url: "https://www.udemy.com/courses/search/?q=prompt+engineering+masterclass" },
      { title: "AI in Technical Project Management", provider: "Udemy", level: "Advanced", url: "https://www.udemy.com/courses/search/?q=technical+project+management+ai" },
      { title: "Full Stack AI Mastery", provider: "Udemy", level: "Advanced", url: "https://www.udemy.com/course/full-stack-ai-mastery/" },
    ],
    "LinkedIn Learning": [
...
export const aiCareerRoadmaps: CareerRoadmap[] = [
  {
    ...
    futureRole: "AI Engineer",
    careerOverview:
      "Career Path: Developer -> Senior Developer -> AI Engineer -> GenAI Engineer -> Agentic AI Engineer. This pathway blends software engineering fundamentals with applied AI implementation, from APIs and RAG to agentic orchestration.",
    skillsNeeded: [
      "Python",
      "FastAPI",
      "React",
    ...
    learningTimeline: "Estimated completion: 8-14 Weeks per role",
    ...
    practiceProjects: [
      "RAG-enabled enterprise knowledge assistant",
      "Agentic workflow automation with LangGraph",
      "React + FastAPI production AI app",
      "Final portfolio: Enterprise AI Assistant with document upload and chat interface",
    ],
    roadmapSteps: [
      { step: 1, phase: "Week 1-2 (Phase 1)", skillArea: "Programming and AI Foundations", whatYouLearn: "Python, APIs, Git and GitHub, OpenAI APIs, AI fundamentals", whyItMatters: "Builds the practical coding base for all AI engineering workflows.", recommendedResource: "Full Stack Generative and Agentic AI with Python" },
      { step: 2, phase: "Week 3-4 (Phase 1)", skillArea: "LLM Fundamentals", whatYouLearn: "Prompt engineering, embeddings, vector databases, AI app development", whyItMatters: "Introduces core LLM patterns used in real-world AI products.", recommendedResource: "AI Engineer Course" },
      { step: 3, phase: "Week 5 (Phase 2)", skillArea: "RAG Engineering", whatYouLearn: "RAG architecture, semantic search, embeddings, ChromaDB, Pinecone", whyItMatters: "RAG improves accuracy and grounding with external knowledge.", recommendedResource: "Gen AI RAG Application Development" },
      { step: 4, phase: "Week 6 (Phase 2)", skillArea: "Full Stack AI Applications", whatYouLearn: "React, FastAPI, LangChain, AI app deployment", whyItMatters: "Connects backend AI logic with user-facing interfaces and deployment.", recommendedResource: "Full Stack AI Mastery: Python, React, FastAPI & LangChain" },
      { step: 5, phase: "Week 7-8 (Phase 3)", skillArea: "LangChain and Retrieval", whatYouLearn: "Chains, memory, tools, agents, retrieval systems", whyItMatters: "Enables modular orchestration for complex LLM applications.", recommendedResource: "LangChain - Develop LLM powered applications with LangChain" },
      { step: 6, phase: "Week 9 (Phase 3)", skillArea: "Agentic AI Engineering", whatYouLearn: "Agentic AI, multi-agent systems, tool calling, structured outputs", whyItMatters: "Creates autonomous and tool-augmented workflows for advanced use cases.", recommendedResource: "Agentic AI Engineering with LangChain & LangGraph" },
      { step: 7, phase: "Week 10 (Phase 4)", skillArea: "Advanced LLM Engineering", whatYouLearn: "Production systems, evaluation, monitoring, optimization, enterprise AI", whyItMatters: "Prepares you to run reliable and measurable LLM systems in production.", recommendedResource: "Master LLM Engineering" },
      { step: 8, phase: "Week 11-12 (Phase 4)", skillArea: "LangGraph Workflows", whatYouLearn: "Agent workflows, human-in-the-loop patterns, state management, orchestration", whyItMatters: "Supports robust multi-agent control flow for enterprise-grade AI products.", recommendedResource: "Complete Agentic AI Bootcamp with LangGraph and LangChain" },
      { step: 9, phase: "Week 13-14 (Phase 5)", skillArea: "Final Portfolio Project", whatYouLearn: "React frontend, FastAPI backend, LangChain, LangGraph, RAG, vector database, authentication, deployment", whyItMatters: "Demonstrates full-stack AI engineering capability with a deployable project.", recommendedResource: "Build Enterprise AI Assistant with RAG, agentic AI, and document-aware chat" },
    ],
  ...
  },
  {
    ...
    futureRole: "AI DevOps Engineer",
    careerOverview:
      "Career Path: DevOps Engineer -> Senior DevOps -> AI DevOps Engineer -> AIOps Engineer -> AI Platform Engineer. This pathway brings AI support into CI/CD, observability, and platform reliability.",
    skillsNeeded: [
      "Docker",
      "Kubernetes",
      "GitHub Actions",
  ...
  },
  {
    ...
    careerOverview:
      "Career Path: Solution Architect -> Enterprise Architect -> AI Architect -> Enterprise AI Architect. This roadmap focuses on system design, cloud AI choices, RAG architecture, and enterprise-grade agent workflows.",
    skillsNeeded: [
    ...
    learningTimeline: "Estimated completion: 8-14 Weeks per role",
    toolsUsed: ["Azure AI", "AWS Bedrock", "LangGraph", "LangChain", "FastAPI", "Kubernetes", "Architecture diagrams"],
    recommendedCertifications: [
      { name: "Azure AI Engineer Associate", description: "Validates practical cloud AI architecture and implementation skills." },
      { name: "AWS AI Practitioner", description: "Builds cloud AI service understanding for enterprise architecture decisions." },
      { name: "TOGAF Foundation", description: "Improves structured enterprise architecture decision-making." },
    ],
    skillLevels: [
      { label: "Beginner", percentage: 34, estimatedDuration: "2-3 Weeks" },
      { label: "Intermediate", percentage: 68, estimatedDuration: "3-4 Weeks" },
      { label: "Advanced", percentage: 100, estimatedDuration: "3-5 Weeks" },
    ],
    practiceProjects: [
      "Enterprise AI reference architecture",
      "RAG and agent workflow blueprint",
      "Cloud AI deployment topology",
      "Capstone: enterprise AI platform architecture case study",
    ],
    roadmapSteps: [
      { step: 1, phase: "Week 1-2", skillArea: "Architecture Foundations", whatYouLearn: "Large-scale system design and architectural trade-offs", whyItMatters: "Strong architecture fundamentals support scalable AI decisions.", recommendedResource: "Software Architecture & Design of Modern Large Scale Systems" },
      { step: 2, phase: "Week 3", skillArea: "Microservices Architecture", whatYouLearn: "Service decomposition and distributed system design", whyItMatters: "AI platforms often rely on decoupled microservice architecture.", recommendedResource: "Microservices Architecture - The Complete Guide" },
      { step: 3, phase: "Week 4", skillArea: "Solutioning with AI", whatYouLearn: "AI presales and architecture communication", whyItMatters: "Architects must align technical design with business value.", recommendedResource: "AI for Presales and Solutions Architects" },
      { step: 4, phase: "Week 5-6", skillArea: "AI Engineering Core", whatYouLearn: "Prompting, embeddings, and production AI workflows", whyItMatters: "Architecture decisions need hands-on understanding of AI implementation patterns.", recommendedResource: "AI Engineer Course" },
      { step: 5, phase: "Week 7-8", skillArea: "RAG Systems", whatYouLearn: "Retrieval, indexing, and context-grounded generation", whyItMatters: "RAG design improves enterprise answer quality and traceability.", recommendedResource: "Gen AI RAG Application Development" },
      { step: 6, phase: "Week 9-12", skillArea: "Agentic Orchestration", whatYouLearn: "Stateful graph workflows and multi-agent orchestration", whyItMatters: "Enterprise AI architecture increasingly requires robust agent control flow.", recommendedResource: "Complete Agentic AI Bootcamp with LangGraph and LangChain" },
      { step: 7, phase: "Week 13-14", skillArea: "Final Capstone Project", whatYouLearn: "Design an enterprise AI architecture roadmap with governance and deployment", whyItMatters: "Capstones demonstrate end-to-end architecture capability for AI leadership roles.", recommendedResource: "Enterprise AI architecture capstone implementation" },
    ],
    resources: roleResources["ai-architect"],
  },
  {
    id: "ai-pm",
    category: "Management",
    currentRole: "Project Manager",
    futureRole: "AI Project Manager",
    careerOverview:
      "Career Path: Project Manager -> Senior PM -> AI PM -> AI Program Manager. This roadmap focuses on AI-assisted planning, reporting, governance, and delivery visibility.",
    skillsNeeded: [
      "AI Planning",
      "AI Reporting",
      "Risk Management",
  ...
  },
  {
    ...
    futureRole: "AI Business Analyst",
    careerOverview:
      "Career Path: Business Analyst -> Senior BA -> AI Business Analyst -> AI Product Analyst. This roadmap helps analysts deliver stronger requirement and documentation workflows with AI.",
    skillsNeeded: [
      "Requirements",
      "User Stories",
      "BRD",
  ...
  },
  {
    ...
    futureRole: "AI Scrum Master",
    careerOverview:
      "Career Path: Scrum Master -> Senior Scrum Master -> AI Scrum Master -> Agile Coach. This roadmap improves planning, agile reporting, and workflow automation using AI.",
    skillsNeeded: [
      "Sprint Planning",
      "Backlog Refinement",
      "Retrospectives",
  ...
  },
  {
    ...
    futureRole: "AI Technical Project Manager",
    careerOverview:
      "Career Path: TPM -> Senior TPM -> AI TPM -> AI Program Manager. This roadmap strengthens technical planning, dependency management, and AI lifecycle delivery.",
    skillsNeeded: [
      "SDLC",
...
export const adsenseDisclaimer =
  "Course availability and pricing are managed by Udemy and may change over time.";
