...
export default function BlogIndexClient({
  ...
  return (
    <div className="space-y-10">
      ...
      {featured.map((post) => (
        <section key={post.slug} className="site-section">
          <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.8fr)] lg:items-center">
            <div>
              ...
              <p className="mt-3 text-sm leading-7 text-slate-700 sm:text-base">{post.description}</p>
      ...
      <section className="site-section">
        ...
        <div className="mt-5 grid gap-4">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm text-slate-900 outline-none ring-blue-500 placeholder:text-slate-400 focus:ring-2"
          />
          <CategoryFilter
