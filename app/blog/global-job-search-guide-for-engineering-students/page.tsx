  ...
  return (
    <main className="mx-auto max-w-5xl space-y-8 px-4 py-10">
      ...
      <section className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
        <h2 className="text-2xl font-bold text-slate-900">Choose the right global route first</h2>
      ...
      <section className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
        <h2 className="text-2xl font-bold text-slate-900">What matters most in global hiring</h2>
        <div className="mt-4 overflow-x-auto rounded-2xl border border-slate-200">
          <table className="min-w-full divide-y divide-slate-200 text-sm">
            ...
            <tbody className="divide-y divide-slate-100 bg-white">
              <tr>
                <td className="px-4 py-3 font-semibold text-slate-900">Role fit</td>
                <td className="px-4 py-3 text-slate-600">Global employers hire for specific skills, not vague ambition.</td>
                <td className="px-4 py-3 text-slate-600">Pick one role family and align projects, resume, and learning.</td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-semibold text-slate-900">Language and communication</td>
                <td className="px-4 py-3 text-slate-600">Interview clarity and workplace communication affect hiring and adaptation.</td>
                <td className="px-4 py-3 text-slate-600">Strengthen English and country-specific communication needs early.</td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-semibold text-slate-900">Portfolio credibility</td>
                <td className="px-4 py-3 text-slate-600">Employers need evidence of real problem solving.</td>
                <td className="px-4 py-3 text-slate-600">Build demonstrable projects, code samples, case studies, or practical work records.</td>
              </tr>
              <tr>
                <td className="px-4 py-3 font-semibold text-slate-900">Visa and work rights</td>
                <td className="px-4 py-3 text-slate-600">Even strong candidates fail when route assumptions are wrong.</td>
                <td className="px-4 py-3 text-slate-600">Verify current country rules from official sources before spending money.</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm sm:p-8">
        <h2 className="text-2xl font-bold text-slate-900">Popular markets students research</h2>
        <div className="mt-4 overflow-x-auto rounded-2xl border border-slate-200">
          <table className="min-w-full divide-y divide-slate-200 text-sm">
            <thead className="bg-slate-50 text-left text-slate-700">
              <tr>
            ...
            <tbody className="divide-y divide-slate-100 bg-white">
              {markets.map((item) => (
                <tr key={item.market}>
                  <td className="px-4 py-3 font-semibold text-slate-900">{item.market}</td>
                  <td className="px-4 py-3 text-slate-600">{item.fit}</td>
                  <td className="px-4 py-3 text-slate-600">{item.watch}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <section className="rounded-3xl border border-sky-200 bg-sky-50 p-6 shadow-sm sm:p-8">
        ...
        <div className="mt-5 flex flex-col gap-3 sm:flex-row">
          ...
          <Link href="/blog/off-campus-placement-guide-for-engineering-students" className="rounded-xl border border-sky-200 bg-white px-5 py-3 text-center text-sm font-semibold text-sky-700 hover:bg-sky-100">
