...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://www.nishaglobaleducation.com/practice-tests/${category}`,
    },
  };
}
  ...
  return (
    <div className="site-page">
      <section className="rounded-3xl border border-slate-700 bg-[#0b1220] p-6 shadow-sm sm:p-8">
        ...
        {isEngineering && (
          <div className="mt-5 max-w-4xl space-y-3 text-sm leading-7 text-slate-300">
            <p>
        ...
        {isGov && (
          <div className="mt-4 flex flex-wrap gap-2">
            {govCategoryData!.audience.map((aud) => (
              <span key={aud} className="rounded-full bg-blue-950/50 px-3 py-1 text-sm text-blue-300">
                {aud}
              </span>
            ))}
          </div>
      ...
      {isIelts && (
        <section className="grid gap-4 lg:grid-cols-2">
          <div className="rounded-3xl border border-emerald-700 bg-slate-800/60 p-6">
            <h2 className="text-xl font-bold text-slate-300">Who should choose this</h2>
          ...
          <div className="rounded-3xl border border-rose-700 bg-rose-950/30 p-6">
            <h2 className="text-xl font-bold text-slate-300">Who should avoid this format</h2>
            <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-7 text-slate-300">
      ...
      {isIelts && (
        <section className="rounded-3xl border border-slate-700 bg-[#0b1220] p-6 shadow-sm">
          <h2 className="text-2xl font-bold text-white">Step-by-step IELTS practice roadmap</h2>
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 1: Choose the correct exam route</p>
            ...
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 2: Build one skill at a time</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
            ...
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 3: Add timed rounds</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
            ...
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 4: Review by skill, not only score</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
      ...
      {isToefl && (
        <section className="rounded-3xl border border-slate-700 bg-[#0b1220] p-6 shadow-sm">
          <h2 className="text-2xl font-bold text-white">Step-by-step TOEFL practice roadmap</h2>
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 1: Set your target score and timeline</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Start with your university requirement and build a weekly practice plan based on time left before test date.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 2: Fix section weaknesses first</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Use section-specific sets to improve weak areas before jumping to full integrated-task rounds.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 3: Add integrated-skill simulations</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Practice read-listen-speak and read-listen-write combinations to build real TOEFL response readiness.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 4: Review by error pattern</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
      ...
      {isIelts && (
        <section className="rounded-3xl border border-slate-700 bg-[#111827] p-6 shadow-sm sm:p-8">
          ...
          <h2 className="mt-4 text-2xl font-bold text-white">How these IELTS practice tests map to real exam needs</h2>
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              ...
              <p className="mt-2 text-sm leading-7 text-slate-300">40 transcript-based questions to train detail capture, focus, and answer checking.</p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Academic Reading</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">For study abroad applicants who need stronger passage analysis and academic vocabulary control.</p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">General Reading</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">For employees and immigrants handling notices, workplace messages, and practical English texts.</p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Writing and Speaking</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">Objective strategy practice to improve structure, fluency habits, and common band-limiting decisions.</p>
            </div>
          </div>
          <div className="mt-5 grid gap-4 lg:grid-cols-2">
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-5 text-sm leading-7 text-slate-300">
              <p className="font-semibold text-white">Choose IELTS Academic if</p>
            ...
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-5 text-sm leading-7 text-slate-300">
              <p className="font-semibold text-white">Choose IELTS General Training if</p>
      ...
      {isToefl && (
        <section className="rounded-3xl border border-slate-700 bg-[#111827] p-6 shadow-sm sm:p-8">
          ...
          <h2 className="mt-4 text-2xl font-bold text-white">How these TOEFL practice tests map to real exam needs</h2>
          <p className="mt-3 max-w-4xl text-base leading-7 text-slate-300">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-5">
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Reading</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">Academic passage logic, inference quality, and evidence-based answer accuracy.</p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Listening</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">Lecture and conversation comprehension with note-based decision control.</p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Speaking</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">Independent and integrated response structure under strict time limits.</p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Writing</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">Integrated writing and academic discussion strategy with coherence focus.</p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Integrated Skills</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">Read-listen-speak and read-listen-write performance for score stability.</p>
            </div>
          </div>
        </section>
      )}
      ...
      {isAviation && (
        <section className="rounded-3xl border border-slate-700 bg-[#111827] p-6 shadow-sm sm:p-8">
          ...
          <h2 className="mt-4 text-2xl font-bold text-white">Choose your role path clearly</h2>
          <p className="mt-3 max-w-4xl text-base leading-7 text-slate-300">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Cabin Crew</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">Passenger service, communication, safety awareness, and high-pressure behavior handling.</p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Ground Staff</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">Check-in process discipline, passenger support, queue control, and documentation awareness.</p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Support Staff</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">Operational support, shift discipline, reporting quality, and safety-first teamwork.</p>
            </div>
          </div>
        </section>
      )}
      ...
      {isSsc && (
        <section className="rounded-3xl border border-slate-700 bg-[#0b1220] p-6 shadow-sm">
          <h2 className="text-2xl font-bold text-white">Step-by-step SSC practice roadmap</h2>
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 1: Build section basics</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
      ...
      {isRailway && (
        <section className="rounded-3xl border border-slate-700 bg-[#0b1220] p-6 shadow-sm">
          <h2 className="text-2xl font-bold text-white">Step-by-step Railway practice roadmap</h2>
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 1: Pick your target pattern</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Choose Group D, NTPC, ALP/Technician, or Ticket Clerk/TT based on your target recruitment notice and post preference.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 2: Start with timed full mocks</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Attempt full papers under exact pattern timing (60 or 90 minutes) to build exam pacing and section switching skill.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 3: Analyze section error types</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Separate errors into concept gaps, calculation mistakes, and time-pressure mistakes so your revision remains focused.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 4: Repeat weak sections weekly</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
      ...
      {isMedical && (
        <section className="rounded-3xl border border-slate-700 bg-[#0b1220] p-6 shadow-sm">
          <h2 className="text-2xl font-bold text-white">Step-by-step NEET practice roadmap</h2>
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 1: Build baseline with Set 1</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Take the first full mock in strict 180 minutes to measure current balance across Physics, Chemistry, and Biology.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 2: Diagnose weak blocks</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Separate mistakes into concept errors, calculation errors, and time-pressure errors for targeted weekly correction.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 3: Rebuild and retest</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Revise weak chapters for 3-5 days, then attempt the next full mock under exact timer conditions.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 4: Lock exam-day strategy</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
      ...
      {isAviation && (
        <section className="rounded-3xl border border-slate-700 bg-[#0b1220] p-6 shadow-sm">
          <h2 className="text-2xl font-bold text-white">Step-by-step aviation preparation roadmap</h2>
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 1: Pick role target first</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
            ...
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 2: Apply through official channels</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
            ...
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 3: Practice interview scenarios</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Train role-specific situations: passenger conflict, delay handling, teamwork pressure, and safety communication.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 4: Build a repeat routine</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
      ...
      {isAviation && (
        <section className="rounded-3xl border border-slate-700 bg-[#0b1220] p-6 shadow-sm">
          <h2 className="text-2xl font-bold text-white">How to apply and prepare interviews</h2>
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4 text-sm leading-7 text-slate-300">
              <p className="font-semibold text-white">Official application checklist</p>
            ...
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4 text-sm leading-7 text-slate-300">
              <p className="font-semibold text-white">Mock interview checklist</p>
            ...
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4 text-sm leading-7 text-slate-300">
              <p className="font-semibold text-white">Role-specific practice tips</p>
            ...
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4 text-sm leading-7 text-slate-300">
              <p className="font-semibold text-white">Avoid common mistakes</p>
      ...
      {isAviation && (
        <section className="rounded-3xl border border-slate-700 bg-[#0b1220] p-6 shadow-sm sm:p-8">
          <h2 className="text-2xl font-bold text-white">English practice guidance for aviation roles</h2>
          <p className="mt-3 max-w-4xl text-base leading-7 text-slate-300">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-3">
            {aviationEnglishGuidance.map((item) => (
              <div key={item.role} className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
      ...
      {isAviation && (
        <section className="rounded-3xl border border-slate-700 bg-[#111827] p-6 shadow-sm sm:p-8">
          <div className="inline-flex rounded-full border border-emerald-700 bg-[#0b1220] px-3 py-1 text-sm font-medium text-slate-300">
            Aviation English Roadmap
          </div>
          <h2 className="mt-4 text-2xl font-bold text-white">Set 1 to Set 5 progression with score benchmarks</h2>
          <p className="mt-3 max-w-4xl text-base leading-7 text-slate-300">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-5">
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 1: Aviation English Set 1</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Focus: basic service phrases, interview grammar, and polite communication lines.
              </p>
              <p className="mt-2 text-sm font-medium text-slate-300">Benchmark to move up: 70% or above</p>
              <Link
                href="/practice-tests/aviation/aviation-english-communication-practice-set-1"
                className="mt-3 inline-flex site-btn-primary px-4 py-2 text-sm"
              >
                Start Set 1
              </Link>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 2: Aviation English Set 2</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Focus: intermediate grammar control, scenario responses, and stronger interview answer quality.
              </p>
              <p className="mt-2 text-sm font-medium text-slate-300">Benchmark to move up: 75% or above</p>
              <Link
            ...
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 3: Aviation English Set 3</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Focus: advanced spoken scenarios, escalation language, and final-round interview communication.
              </p>
              <p className="mt-2 text-sm font-medium text-slate-300">Benchmark to move up: 80% or above</p>
              <Link
            ...
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 4: Aviation English Set 4</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Focus: advanced policy language, escalation clarity, and multi-step spoken scenario control.
              </p>
              <p className="mt-2 text-sm font-medium text-slate-300">Benchmark to move up: 82% or above</p>
              <Link
            ...
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 5: Aviation English Set 5</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Focus: final interview mastery with high-pressure communication and consistent response quality.
              </p>
              <p className="mt-2 text-sm font-medium text-slate-300">Final readiness target: 85% or above</p>
              <Link
      ...
      {isAviation && (
        <section className="rounded-3xl border border-slate-700 bg-[#111827] p-6 shadow-sm sm:p-8">
          ...
          <h2 className="mt-4 text-2xl font-bold text-white">Daily spoken English plan for aviation interviews</h2>
          <p className="mt-3 max-w-4xl text-base leading-7 text-slate-300">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            {aviationSpokenEnglish14DayPlan.map((item) => (
              <div key={item.day} className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
                <p className="text-xs font-semibold uppercase tracking-wide text-blue-300">{item.day}</p>
                <p className="mt-2 text-sm font-semibold text-white">{item.focus}</p>
                <p className="mt-2 text-sm leading-7 text-slate-300">{item.task}</p>
              </div>
            ))}
          </div>
        </section>
      ...
      {isAviation && (
        <section className="rounded-3xl border border-slate-700 bg-[#0b1220] p-6 shadow-sm sm:p-8">
          <h2 className="text-2xl font-bold text-white">Mock interview questions with sample answers</h2>
          <p className="mt-3 max-w-4xl text-base leading-7 text-slate-300">
          ...
          <div className="mt-5 grid gap-4 lg:grid-cols-3">
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Cabin Crew Interview Q&A</p>
              <div className="mt-3 space-y-3">
                {aviationInterviewQa.cabinCrew.map((item) => (
                  <div key={item.q} className="rounded-xl border border-slate-700 bg-[#0b1220] p-3">
                    <p className="text-sm font-semibold text-white">Q: {item.q}</p>
                    <p className="mt-2 text-sm leading-7 text-slate-300">A: {item.a}</p>
                  </div>
                ))}
              </div>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Ground Staff Interview Q&A</p>
              <div className="mt-3 space-y-3">
            ...
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Support Staff Interview Q&A</p>
              <div className="mt-3 space-y-3">
      ...
      {isAviation && (
        <section className="rounded-3xl border border-slate-700 bg-[#111827] p-6 shadow-sm sm:p-8">
          ...
          <h2 className="mt-4 text-2xl font-bold text-white">Verified aviation career and authority links</h2>
          <p className="mt-3 max-w-4xl text-base leading-7 text-slate-300">
          ...
          <div className="mt-4 rounded-2xl border border-amber-700 bg-amber-950/40 p-4 text-sm leading-7 text-slate-300">
            <p>
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-2">
            {aviationOfficialLinks.map((item) => (
              <a
                ...
                className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4 transition hover:border-sky-300 hover:shadow-sm"
              >
                <div className="inline-flex rounded-full bg-blue-950/50 px-2.5 py-1 text-xs font-semibold uppercase tracking-wide text-blue-300">
                  {item.type}
                </div>
                <p className="mt-3 text-base font-semibold text-white">{item.name}</p>
                <p className="mt-2 text-sm leading-7 text-slate-300">{item.note}</p>
                <p className="mt-3 text-sm font-medium text-blue-300">Open official page</p>
              </a>
            ))}
          </div>
          <div className="mt-5 rounded-2xl border border-slate-700 bg-slate-800/70 p-5 text-sm leading-7 text-slate-300">
            <p className="font-semibold text-white">Safe-application reminder</p>
      ...
      {isSsc && (
        <section className="rounded-3xl border border-slate-700 bg-[#111827] p-6 shadow-sm sm:p-8">
          ...
          <h2 className="mt-4 text-2xl font-bold text-white">How to use SSC full-length mocks effectively</h2>
          <p className="mt-3 max-w-4xl text-base leading-7 text-slate-300">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Tier I Full Mocks</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">100 questions in 60 minutes with balanced objective section coverage.</p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">CHSL Full Mocks</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">100 questions in 60 minutes to improve accuracy with CHSL-style pacing.</p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Tier II Full Mocks</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">150 questions in 120 minutes for advanced practice and exam stamina.</p>
            </div>
          </div>
        </section>
      )}
      ...
      {isRailway && (
        <section className="rounded-3xl border border-slate-700 bg-[#111827] p-6 shadow-sm sm:p-8">
          ...
          <h2 className="mt-4 text-2xl font-bold text-white">How these Railway tracks map to real exam practice</h2>
          <p className="mt-3 max-w-4xl text-base leading-7 text-slate-300">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">RRB Group D CBT</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">100 questions in 90 minutes with balanced math, reasoning, science, and GA coverage.</p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">RRB NTPC CBT-1</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">100 questions in 90 minutes focused on mathematics, reasoning, and general awareness.</p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">RRB ALP/Technician CBT-1</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">75 questions in 60 minutes to train fast decision-making and section balance.</p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">RRB Ticket Clerk / TT</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">100 questions in 90 minutes following practical NTPC-style objective structure.</p>
            </div>
          </div>
        </section>
      )}
      ...
      {isMedical && (
        <section className="rounded-3xl border border-slate-700 bg-[#111827] p-6 shadow-sm sm:p-8">
          ...
          <h2 className="mt-4 text-2xl font-bold text-white">How these Medical NEET mocks map to real exam preparation</h2>
          <p className="mt-3 max-w-4xl text-base leading-7 text-slate-300">
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Physics</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">45 questions for formula application, concept clarity, and calculation control.</p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Chemistry</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">45 questions covering physical, organic, and inorganic decision-making speed.</p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Biology</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">90 questions to strengthen high-weight retention, elimination, and accuracy.</p>
            </div>
          </div>
          <div className="mt-5 rounded-2xl border border-slate-700 bg-slate-800/70 p-5 text-sm leading-7 text-slate-300">
            <p>
      ...
      {isCtet && (
        <section className="rounded-3xl border border-slate-700 bg-[#111827] p-6 shadow-sm sm:p-8">
          ...
          <h2 className="mt-4 text-2xl font-bold text-white">How to use CTET full-length mocks on this page</h2>
          <p className="mt-3 max-w-4xl text-base leading-7 text-slate-300">
      ...
      {isEngineering && (
        <section className="rounded-3xl border border-slate-700 bg-[#0b1220] p-6 shadow-sm">
          <h2 className="text-2xl font-bold text-white">Step-by-step practice roadmap</h2>
          <div className="mt-4 grid gap-4 md:grid-cols-2">
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 1: Foundation (Week 1-2)</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Start with beginner sets to stabilize algebra, arithmetic speed, mechanics basics, and chemistry fundamentals.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 2: Exam Track (Week 3-6)</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Pick your target exam track and solve exam-style sets regularly. Track accuracy separately for each subject.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 3: Timed Rounds (Week 7-8)</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
                Attempt sets under strict time limits. Build decision speed: skip, solve, review, and attempt strategy.
              </p>
            </div>
            <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
              <p className="text-sm font-semibold text-white">Step 4: Revision Loop (Ongoing)</p>
              <p className="mt-2 text-sm leading-7 text-slate-300">
      ...
      {isEngineering && (
        <section className="rounded-3xl border border-slate-700 bg-[#111827] p-6 shadow-sm sm:p-8">
          ...
          <h2 className="mt-4 text-2xl font-bold text-white">How to use the 180-question COMEDK sets</h2>
          <p className="mt-3 max-w-4xl text-base leading-7 text-slate-300">
      ...
      {isGov && (
        <section className="rounded-3xl border border-slate-700 bg-[#0b1220] p-6 shadow-sm">
          <h2 className="text-xl font-bold text-white">Chapters Covered</h2>
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            {govCategoryData.chapters.map((chap) => (
              <div key={chap.name} className="flex items-center gap-3 rounded-lg border border-slate-700 p-3">
                <span className="text-2xl">{govCategoryData.icon}</span>
                <div>
                  <div className="font-medium text-white">{chap.name}</div>
                  {!isMedical && <div className="text-sm text-slate-300">{chap.hi}</div>}
                </div>
              </div>
            ))}
          </div>
          ...
          {isGov ? (
            <>
                ...
                >
                  <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    <div className="max-w-3xl">
                      ...
                      {set.bilingual && <p className="mt-1 text-sm text-slate-300">{set.titleHi}</p>}
                      ...
                      <div className="mt-5 flex flex-wrap gap-2 text-sm font-medium text-slate-300">
                        ...
                        {set.bilingual && (
                          <span className="rounded-full bg-emerald-950/40 px-3 py-1 text-slate-300">
                            Bilingual
                          </span>
                        )}
                      </div>
              ...
              {govCategoryData.sets.filter(s => !s.isLive).length > 0 && (
                <>
                  <h3 className="text-xl font-bold text-white">Planned Next</h3>
                  {govCategoryData.sets.filter(s => !s.isLive).map((set) => (
                    <div
                      key={set.slug}
                      className="rounded-3xl border-2 border-dashed border-slate-600 bg-slate-800/50 p-6"
                    >
                      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                        <div className="max-w-3xl">
                        ...
                        <div className="rounded-xl bg-gray-300 px-5 py-3 text-center font-semibold text-slate-300">
                          Planned
                        </div>
                      </div>
                    </div>
            ...
            getEngineeringPracticeGroups().map((group) => (
              <div key={group.examSlug} className="space-y-6">
                <div className="rounded-3xl border border-slate-700 bg-[#0b1220] p-6 shadow-sm">
                  <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                    <div className="max-w-3xl">
                      <div className="inline-flex rounded-full border border-slate-700 bg-slate-800/70 px-3 py-1 text-sm font-medium text-slate-300">
                        {group.shortName}
                      </div>
                      ...
                      <div className="mt-4 grid gap-2 sm:grid-cols-2">
                        ...
                        <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4 text-sm text-slate-300">
                          <div className="font-semibold text-white">Subjects</div>
                      ...
                      {group.note && (
                        <p className="mt-4 rounded-2xl border border-slate-700 bg-slate-800/70 p-4 text-sm text-slate-300">
                          {group.note}
                        </p>
                      )}
                    </div>
                  ...
                  {group.disclaimer && (
                    <div className="mt-5 rounded-2xl border border-amber-700 bg-amber-950/40 p-4 text-sm text-slate-300">
                ...
                {group.examSlug === "kcet" && (
                  <section className="rounded-3xl border border-slate-700 bg-[#0b1220] p-6 shadow-sm">
                    <h3 className="text-xl font-bold text-white">KCET quick FAQs</h3>
                    <div className="mt-4 space-y-3">
                      {kcetFaqs.map((faq) => (
                        <details key={faq.q} className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
                ...
                {group.examSlug === "wbjee" && (
                  <section className="rounded-3xl border border-slate-700 bg-[#0b1220] p-6 shadow-sm">
                    <h3 className="text-xl font-bold text-white">WBJEE quick FAQs</h3>
                    <div className="mt-4 space-y-3">
                      {wbjeeFaqs.map((faq) => (
                        <details key={faq.q} className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
                          <summary className="cursor-pointer text-sm font-semibold text-white">{faq.q}</summary>
                ...
                {group.examSlug === "jee-advanced" && (
                  <section className="rounded-3xl border border-slate-700 bg-[#0b1220] p-6 shadow-sm">
                    <h3 className="text-xl font-bold text-white">JEE Advanced quick FAQs</h3>
                    <div className="mt-4 space-y-3">
                ...
                {group.examSlug === "jee-main" && (
                  <section className="rounded-3xl border border-slate-700 bg-[#0b1220] p-6 shadow-sm">
                    <h3 className="text-xl font-bold text-white">JEE Main quick FAQs</h3>
                    <div className="mt-4 space-y-3">
                      {jeeMainFaqs.map((faq) => (
                        <details key={faq.q} className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4">
                          <summary className="cursor-pointer text-sm font-semibold text-white">{faq.q}</summary>
                  ...
                  {group.sets.length > 0 ? (
                    group.sets.map((set) => (
                      ...
                      >
                        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                          <div className="max-w-3xl">
                            <span className="inline-flex rounded-full bg-slate-800 px-3 py-1 text-sm font-medium text-slate-300">
                              {set.sectionLabel || set.examName || set.examType}
                            </span>
                            <h4 className="mt-4 text-2xl font-bold text-white">{set.title}</h4>
                            <p className="mt-3 text-sm leading-7 text-slate-300">{set.description}</p>
                            <div className="mt-5 flex flex-wrap gap-2 text-sm font-medium text-slate-300">
                              <span className="rounded-full bg-slate-800 px-3 py-1">{set.questionCount} Questions</span>
                              <span className="rounded-full bg-slate-800 px-3 py-1">~{set.estimatedMinutes} min</span>
                              <span className="rounded-full bg-slate-800 px-3 py-1 capitalize">{set.level}</span>
                            </div>
                          </div>
                    ...
                    <div className="rounded-3xl border border-slate-700 bg-slate-800/70 p-6 text-slate-300">
            ...
            <>
                  ...
                  <div className="rounded-3xl border border-slate-700 bg-[#0b1220] p-6 shadow-sm">
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                      <div className="max-w-3xl">
                        ...
                        <h3 className="mt-4 text-2xl font-bold text-white">{group.title}</h3>
                        <p className="mt-3 text-sm leading-7 text-slate-300">{group.description}</p>
                        <div className="mt-4 grid gap-2 sm:grid-cols-2">
                          <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4 text-sm text-slate-300">
                            <div className="font-semibold text-white">Real-test format</div>
                            <div className="mt-1">{group.format}</div>
                          </div>
                          <div className="rounded-2xl border border-slate-700 bg-slate-800/70 p-4 text-sm text-slate-300">
                            <div className="font-semibold text-white">Real-test timing</div>
                            <div className="mt-1">{group.duration}</div>
                          </div>
                        </div>
                        <p className="mt-4 text-sm leading-7 text-slate-300">{group.bestFor}</p>
                        <p className="mt-4 rounded-2xl border border-slate-700 bg-slate-800/70 p-4 text-sm leading-7 text-slate-300">{group.note}</p>
                      </div>
                    </div>
                  </div>
              ...
              {ieltsFoundationSets.length > 0 && (
                <div className="space-y-4">
                  <h3 className="text-xl font-bold text-white">Foundation English Basics</h3>
                  ...
                  <div className="grid gap-4">
                    {ieltsFoundationSets.map((set) => (
                      ...
                      >
                        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                          <div className="max-w-3xl">
                            <h4 className="text-2xl font-bold text-white">{set.title}</h4>
                            <p className="mt-3 text-sm leading-7 text-slate-300">{set.description}</p>
                            <div className="mt-5 flex flex-wrap gap-2 text-sm font-medium text-slate-300">
                              <span className="rounded-full bg-slate-800 px-3 py-1">{set.questionCount} Questions</span>
                              <span className="rounded-full bg-slate-800 px-3 py-1">~{set.estimatedMinutes} min</span>
      ...
      {isCtet && (
        <section className="rounded-3xl border border-amber-700 bg-amber-950/40 p-6 shadow-sm">
          <h2 className="text-xl font-bold text-white">Content trust and update policy</h2>
