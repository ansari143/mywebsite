...
export default async function PracticeCategoryPage({ params }: Props) {
  ...
  return (
    <div className="space-y-8 dark:[&_.border-gray-200]:border-slate-700 dark:[&_.border-slate-200]:border-slate-700 dark:[&_.border-slate-300]:border-slate-600 dark:[&_.bg-white]:bg-slate-900 dark:[&_.bg-slate-50]:bg-slate-800 dark:[&_.bg-gray-50]:bg-slate-800 dark:[&_.text-slate-900]:text-slate-100 dark:[&_.text-slate-700]:text-slate-200 dark:[&_.text-slate-600]:text-slate-300 dark:[&_.text-gray-700]:text-slate-300 dark:[&_.text-gray-600]:text-slate-400 dark:[&_.text-green-700]:text-green-300 dark:[&_.text-red-700]:text-red-300">
