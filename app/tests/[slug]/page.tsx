...
export default async function StreamDetail({
  ...
  return (
    <div className="site-page space-y-8">
      <section className="site-section">
        <div className="inline-flex rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-sm font-medium text-blue-800">
        ...
        <div className="mt-4 flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-3 text-slate-600">{test.summary}</p>
          </div>
        </div>
      ...
      <section className="grid gap-4 lg:grid-cols-2">
        <div className="site-section border-emerald-200 bg-emerald-50/60">
          <h2 className="text-xl font-bold text-emerald-900">Who should choose this</h2>
          <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-7 text-emerald-800">
        ...
        <div className="site-section border-rose-200 bg-rose-50/60">
          <h2 className="text-xl font-bold text-rose-900">Who should avoid this format</h2>
          <ul className="mt-3 list-disc space-y-2 pl-5 text-sm leading-7 text-rose-800">
      ...
      <div className="grid gap-6 md:grid-cols-[2fr_1fr]">
        <div className="site-section">
          <div className="text-4xl">{test.icon}</div>
          <h2 className="mt-2 text-2xl font-bold text-slate-900">Test overview</h2>
          <p className="mt-3 text-slate-600">{test.summary}</p>

          <h3 className="mt-6 font-semibold text-slate-900">Skills Required</h3>
          ...
          <h3 className="mt-6 font-semibold text-slate-900">What you will get</h3>
        ...
        <aside className="site-section h-fit md:sticky md:top-24">
          <p className="text-sm font-semibold text-slate-900">Test Info</p>
          ...
          <Link
            ...
            className="site-btn-primary mt-5 w-full px-4 py-3 text-center"
          >
            Start Test
          </Link>
        </aside>
      ...
      <section className="site-section">
        ...
        <div className="mt-4 space-y-3">
          {testFaqs.map((faq) => (
            <details key={faq.q} className="rounded-2xl border border-slate-200 bg-white p-4">
