...
export default function DisclaimerPage() {
  ...
  return (
    <div className="rounded-3xl border border-gray-200 bg-[#15233d] p-6 shadow-sm sm:p-8 dark:border-slate-700 dark:bg-slate-900 dark:[&_.text-white]:text-slate-100 dark:[&_.text-white]:text-slate-300 dark:[&_.text-white]:text-slate-300">
      <script
      ...
      <div className="mt-5 space-y-4 text-sm leading-7 text-white sm:text-base">
        ...
        <h2 className="font-semibold text-white">No Professional or Legal Advice</h2>
        <p>
        ...
        <h2 className="font-semibold text-white">Changing Policies and Information</h2>
        <p>
        ...
        <h2 className="font-semibold text-white">No Affiliation</h2>
        <p>
        ...
        <h2 className="font-semibold text-white">Third-Party Content and Advertisements</h2>
        <p>
