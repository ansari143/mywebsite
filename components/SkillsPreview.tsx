    ...
    <section className="space-y-6">
      <div className="rounded-3xl border border-gray-200 bg-gradient-to-br from-white via-blue-50/30 to-indigo-50/40 p-6 shadow-sm sm:p-8 dark:border-slate-700 dark:from-slate-900 dark:via-slate-900 dark:to-slate-800">
        <div className="max-w-3xl">
          <div className="inline-flex rounded-full border border-blue-100 bg-blue-50 px-3 py-1 text-sm font-medium text-blue-700 dark:border-blue-500/50 dark:bg-blue-900/30 dark:text-blue-200">
            Future-Ready Skills
          </div>
      ...
      <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
        {skills.map((skill, index) => (
          <Link
            key={skill.title}
            href={skill.href}
            className="group rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition hover:-translate-y-1 hover:border-blue-200 hover:shadow-md dark:border-slate-700 dark:bg-slate-900 dark:hover:border-blue-400/50"
          >
            <div
            ...
            <h3 className="mt-4 text-lg font-semibold text-slate-900 group-hover:text-blue-700 dark:text-slate-100 dark:group-hover:text-blue-300">
              {skill.title}
            </h3>
