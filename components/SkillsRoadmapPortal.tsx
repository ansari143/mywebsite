...
export default function SkillsRoadmapPortal({
  ...
  return (
    <div className="space-y-10">
          ...
          <div className="grid gap-4 rounded-2xl border border-white/20 bg-white/10 p-4 backdrop-blur md:grid-cols-[2fr_1fr_1fr]">
            <label className="block">
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/30 bg-white/95 px-4 py-3 text-sm text-slate-900 outline-none ring-blue-300 transition focus:ring dark:border-slate-500 dark:bg-slate-800 dark:text-slate-100"
              />
            </label>
      ...
      <section
        id="roadmaps"
        className="scroll-mt-24 space-y-6 rounded-3xl border border-slate-200 bg-white/70 p-4 backdrop-blur-sm sm:p-6 dark:border-slate-700 dark:bg-slate-950/70"
      >
        <div className="flex flex-wrap items-end justify-between gap-3">
          ...
          <p className="rounded-full border border-slate-300 bg-slate-50 px-3 py-1 text-xs font-semibold text-slate-700 dark:border-slate-600 dark:bg-slate-800/90 dark:text-slate-100">
        ...
        <div className="space-y-5">
          {filteredRoadmaps.map((roadmap) => {
            ...
            return (
              <article key={roadmap.id} className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-900">
                <button
                  suppressHydrationWarning
                  type="button"
                  onClick={() =>
                ...
                >
                  <div>
                    ...
                    <p className="mt-2 inline-flex rounded-full border border-emerald-200 bg-emerald-50 px-2 py-0.5 text-[11px] font-semibold text-emerald-700">
                      🚀 Future Ready 2026
                    </p>
                  </div>
                ...
                {expandedRoleId === roadmap.id ? (
                  <div className="space-y-6 p-5 sm:p-6">
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
                      <h4 className="text-base font-semibold text-slate-900 dark:text-slate-100">Career Overview</h4>
                      <p className="mt-2 text-sm leading-7 text-slate-600 dark:text-slate-300">{roadmap.careerOverview}</p>
                      {roadmap.id === "ai-engineer" ? (
                        <div className="mt-4 rounded-2xl border border-blue-100 bg-blue-50 p-4 dark:border-blue-700 dark:bg-blue-900/30">
                    ...
                    <div className="grid gap-4 lg:grid-cols-2">
                      <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
                        <h4 className="text-base font-semibold text-slate-900 dark:text-slate-100">Skills Needed</h4>
                        <div className="mt-3 flex flex-wrap gap-2">
                          {roadmap.skillsNeeded.map((skill) => (
                            <span
                              key={skill}
                              className="rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-xs font-medium text-blue-800 dark:border-blue-700 dark:bg-blue-900/30 dark:text-blue-200"
                            >
                              {skill}
                            </span>
                          ))}
                      ...
                      <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
                        <h4 className="text-base font-semibold text-slate-900 dark:text-slate-100">Estimated Duration</h4>
                          ...
                          {roadmap.skillLevels.map((level) => (
                            <div key={level.label}>
                              <div className="mb-1 flex items-center justify-between text-xs font-semibold text-slate-600 dark:text-slate-300">
                                <span className="rounded-full border border-slate-300 bg-slate-50 px-2 py-0.5 dark:border-slate-600 dark:bg-slate-800">
                                  {level.label}
                                </span>
                    ...
                    <div className="grid gap-4 lg:grid-cols-2">
                      <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
                        <h4 className="text-base font-semibold text-slate-900 dark:text-slate-100">Tools Used</h4>
                        <div className="mt-3 flex flex-wrap gap-2">
                      ...
                      <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
                        <h4 className="text-base font-semibold text-slate-900 dark:text-slate-100">Recommended Certifications</h4>
                        <div className="mt-3 space-y-3">
                          {roadmap.recommendedCertifications.map((certification) => (
                            <div key={certification.name} className="rounded-xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-700 dark:bg-slate-800">
                              <p className="text-sm font-semibold text-slate-800 dark:text-slate-100">{certification.name}</p>
                              <p className="mt-1 text-sm leading-6 text-slate-600 dark:text-slate-300">{certification.description}</p>
                            </div>
                          ))}
                        </div>
                      </div>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
                      <h4 className="text-base font-semibold text-slate-900 dark:text-slate-100">Roadmap Table</h4>
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
                      <h4 className="text-base font-semibold text-slate-900 dark:text-slate-100">Recommended Learning Resources</h4>
                      <div className="mt-3 flex flex-wrap gap-2">
                    ...
                    <div className="rounded-2xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
                      <h4 className="text-base font-semibold text-slate-900 dark:text-slate-100">Final Capstone Project</h4>
                      <div className="mt-3 grid gap-2 sm:grid-cols-2">
                        {roadmap.practiceProjects.map((project) => (
                          <div
                            key={`${roadmap.id}-${project}`}
                            className="rounded-xl border border-indigo-200 bg-indigo-50 px-3 py-2 text-sm font-medium text-indigo-900 dark:border-indigo-700 dark:bg-indigo-900/30 dark:text-indigo-200"
                          >
                            {project}
                          </div>
                        ))}
      ...
      <section className="rounded-3xl border border-emerald-200 bg-gradient-to-r from-emerald-50 via-white to-cyan-50 p-6 shadow-sm sm:p-8 dark:border-emerald-700 dark:from-emerald-900/30 dark:via-slate-900 dark:to-cyan-900/30">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Become AI Driven</h2>
            <p className="mt-2 text-sm leading-7 text-slate-700 dark:text-slate-300">
      ...
      <section id="seo-content" className="scroll-mt-24 space-y-5 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8 dark:border-slate-700 dark:bg-slate-900">
        <div>
          <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl dark:text-slate-100">AI Career Guidance Content</h2>
        ...
        {seoSections.map((section) => (
          <article key={section.id} className="rounded-2xl border border-slate-200 bg-slate-50 p-5 dark:border-slate-700 dark:bg-slate-800">
            <h3 className="text-xl font-semibold text-slate-900 dark:text-slate-100">{section.title}</h3>
            <div className="mt-3 space-y-4 text-sm leading-8 text-slate-700 dark:text-slate-300">
      ...
      <section className="rounded-3xl border border-blue-200 bg-gradient-to-br from-blue-50 via-white to-indigo-50 p-6 shadow-sm sm:p-8 dark:border-blue-700 dark:from-blue-900/30 dark:via-slate-900 dark:to-indigo-900/30">
        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Internal Guidance Links</h2>
        <p className="mt-2 text-sm leading-7 text-slate-600 dark:text-slate-300">
      ...
      <section id="faq" className="scroll-mt-24 rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8 dark:border-slate-700 dark:bg-slate-900">
        <h2 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Frequently Asked Questions</h2>
        <div className="mt-5 space-y-4">
          {faqItems.map((item) => (
            <article key={item.question} className="rounded-2xl border border-slate-200 bg-slate-50 p-4 dark:border-slate-700 dark:bg-slate-800">
